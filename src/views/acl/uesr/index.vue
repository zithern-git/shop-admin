<template>
  ...
  <el-card>
    <el-form>
      ...
      <el-form-item>
        <el-table :data="userArr" border>
          ...
          <el-table-column label="用户角色" align="center" prop="role" show-overflow-tooltip></el-table-column>
    ...
    <el-drawer v-model="drawer" :title="showPassword? '添加用户' : '修改用户'">
      <el-form>
        <el-form-item label="用户姓名"><el-input v-model="userParams.username" placeholder="请填写用户名字" /></el-form-item>
        <el-form-item label="用户昵称"><el-input v-model="userParams.name" placeholder="请填写用户昵称" /></el-form-item>
        <el-form-item label="用户密码" v-show="showPassword"><el-input v-model="userParams.password" placeholder="请填写用户密码" /></el-form-item>
      </el-form>
      <template #footer>
      <div style="flex: auto">
